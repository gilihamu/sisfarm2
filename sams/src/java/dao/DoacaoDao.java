    ...
    public Doacao consultar(Doacao doacao)
{
    ...
    public Collection<Doacao> consultarDoacoes(Integer idEntidade, String dsProduto){
        ...
        return getPureList(Doacao.class, "FROM Doacao d WHERE d.entidade.idEntidade <> ? AND d.produtos.dsProduto like ? AND d.usuarioExclusao.codUsuario is null", idEntidade,dsProduto);
    }
